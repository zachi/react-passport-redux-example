...
var _intakes = require("./controllers/intakes");

var _intakes2 = _interopRequireDefault(_intakes);
...
app.post("/intake", _intakes2.default.save);
app.get("/intakeScore", _intakes2.default.getScore);
